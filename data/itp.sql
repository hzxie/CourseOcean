...
--
-- Host: localhost
-- Generation Time: Oct 22, 2014 at 10:35 下午
...
CREATE TABLE IF NOT EXISTS `itp_companies` (
  ...
  PRIMARY KEY (`uid`),
  KEY `company_field_id` (`company_field_id`)
