...
--
-- Host: localhost
-- Generation Time: Dec 28, 2014 at 01:47 下午
...
INSERT INTO `co_comments` (`comment_id`, `lecture_id`, `reviewer_uid`, `comment_time`, `comment_ranking`, `comment_detail`) VALUES
...
--
-- Table structure for table `co_companies`
--

CREATE TABLE IF NOT EXISTS `co_companies` (
...
--
-- Dumping data for table `co_companies`
--

INSERT INTO `co_companies` (`uid`, `is_approved`, `company_name`, `company_region`, `company_province`, `company_city`, `company_address`, `company_field_id`, `company_scale`, `company_phone`) VALUES
(1004, 1, '合肥网迅软件有限公司', '华东地区', '安徽省', '合肥市', '合肥市高新区香樟大道308号网迅大厦IFC金融中心项目', 1, 100, '0551-62368898');

-- --------------------------------------------------------

--
-- Table structure for table `co_company_fields`
--

CREATE TABLE IF NOT EXISTS `co_company_fields` (
`company_field_id` int(4) NOT NULL,
...
--
-- Dumping data for table `co_company_fields`
--

INSERT INTO `co_company_fields` (`company_field_id`, `company_field_slug`, `company_field_name`) VALUES
...
--
-- Table structure for table `co_courses`
--

CREATE TABLE IF NOT EXISTS `co_courses` (
...
--
-- Dumping data for table `co_courses`
--

INSERT INTO `co_courses` (`course_id`, `course_name`, `course_is_public`, `course_type_id`, `teacher_id`, `course_cycle`, `course_audience`, `course_brief`, `course_objective`) VALUES
...
--
-- Table structure for table `co_course_composition`
--

CREATE TABLE IF NOT EXISTS `co_course_composition` (
  `course_id` bigint(20) NOT NULL,
  `course_module_id` bigint(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `co_course_composition`
--

INSERT INTO `co_course_composition` (`course_id`, `course_module_id`) VALUES
(100, 100),
(100, 101),
(100, 102),
(101, 103),
...
--
-- Table structure for table `co_course_modules`
--

CREATE TABLE IF NOT EXISTS `co_course_modules` (
`course_module_id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `co_course_modules`
--

INSERT INTO `co_course_modules` (`course_module_id`, `course_module_name`, `teacher_id`, `course_module_cycle`, `course_module_brief`, `course_module_outline`) VALUES
...
--
-- Table structure for table `co_course_types`
--

CREATE TABLE IF NOT EXISTS `co_course_types` (
`course_type_id` int(4) NOT NULL,
...
--
-- Dumping data for table `co_course_types`
--

INSERT INTO `co_course_types` (`course_type_id`, `course_type_slug`, `course_type_name`, `course_type_parent`) VALUES
...
--
-- Table structure for table `co_email_validation`
--

CREATE TABLE IF NOT EXISTS `co_email_validation` (
  `email` varchar(64) NOT NULL,
  `keycode` varchar(32) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `co_email_validation`
--
...
--
-- Table structure for table `co_lectures`
--

CREATE TABLE IF NOT EXISTS `co_lectures` (
`lecture_id` bigint(20) NOT NULL,
  `course_id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `co_lectures`
--

INSERT INTO `co_lectures` (`lecture_id`, `course_id`, `lecture_create_time`, `lecture_start_time`, `lecture_end_time`, `lecture_region`, `lecture_province`, `lecture_city`, `lecture_address`, `lecture_min_capcity`, `lecture_max_capcity`, `lecture_expense`, `lecture_precautions`) VALUES
...
--
-- Table structure for table `co_lecture_attendance`
--

CREATE TABLE IF NOT EXISTS `co_lecture_attendance` (
  `uid` bigint(20) NOT NULL,
  `lecture_id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `co_lecture_attendance`
--

INSERT INTO `co_lecture_attendance` (`uid`, `lecture_id`, `serial_code`, `total_times`, `remain_times`) VALUES
...
--
-- Table structure for table `co_lecture_schedule`
--

CREATE TABLE IF NOT EXISTS `co_lecture_schedule` (
  `lecture_id` bigint(20) NOT NULL,
  `course_module_id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `co_lecture_schedule`
--

INSERT INTO `co_lecture_schedule` (`lecture_id`, `course_module_id`, `course_module_start_time`, `course_module_end_time`) VALUES
...
--
-- Table structure for table `co_messages`
--

CREATE TABLE IF NOT EXISTS `co_messages` (
...
--
-- Table structure for table `co_options`
--

CREATE TABLE IF NOT EXISTS `co_options` (
...
--
-- Dumping data for table `co_options`
--

INSERT INTO `co_options` (`option_id`, `option_key`, `option_value`) VALUES
(1, 'co_name', 'IT培训平台'),
(2, 'co_introduction', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.');

-- --------------------------------------------------------

--
-- Table structure for table `co_people`
--
...
--
-- Dumping data for table `co_people`
--

INSERT INTO `co_people` (`uid`, `person_name`, `person_region`, `person_province`, `person_city`, `person_company`, `person_position_id`, `person_phone`) VALUES
...
INSERT INTO `co_positions` (`position_id`, `position_slug`, `position_name`) VALUES
(1, 'programmer', '程序员'),
...
--
-- Table structure for table `co_posts`
--

CREATE TABLE IF NOT EXISTS `co_posts` (
...
--
-- Dumping data for table `co_posts`
--

INSERT INTO `co_posts` (`post_id`, `post_category_id`, `post_date`, `post_title`, `post_content`) VALUES
...
(2, 1, '2014-08-05 15:59:15', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.');

-- --------------------------------------------------------

--
-- Table structure for table `co_post_categories`
--

CREATE TABLE IF NOT EXISTS `co_post_categories` (
`post_category_id` int(4) NOT NULL,
...
--
-- Dumping data for table `co_post_categories`
--

INSERT INTO `co_post_categories` (`post_category_id`, `post_category_slug`, `post_category_name`) VALUES
(1, 'uncatalogued', '未分类');

-- --------------------------------------------------------

--
-- Table structure for table `co_requirements`
--

CREATE TABLE IF NOT EXISTS `co_requirements` (
...
--
-- Dumping data for table `co_requirements`
--

INSERT INTO `co_requirements` (`requirement_id`, `requirement_is_accepted`, `requirement_from_uid`, `requirement_to_uid`, `requirement_course_id`, `requirement_create_time`, `requirement_participants`, `requirement_start_time`, `requirement_end_time`, `requirement_region`, `requirement_province`, `requirement_city`, `requirement_address`, `requirement_expense`, `requirement_detail`) VALUES
...
--
-- Dumping data for table `co_teachers`
--

INSERT INTO `co_teachers` (`uid`, `teacher_name`, `teacher_brief`, `teacher_avatar`, `teacher_region`, `teacher_province`, `teacher_city`, `teacher_company`, `teacher_phone`, `teacher_weibo`) VALUES
(100, '杨锋镝', '杨锋镝是一位有着十余年从业经验的软件工程专家、资深技术管理者、培训师、咨询师. 他先后在UTStarcom、华为等企业从事过软件研发过程中涉及的大部分岗位：需求、设计、开发、测试、实施、维护、项目管理、团队管理、敏捷教练、人力资源管理, 同时还是多项技术专利的发明人. 丰富的职业跨界经历使他深刻体会各岗位的痛点, 能贴合客户需求提供务实的咨询服务. 近年来, 他研发了敏捷软件开发、从技术到管理等系列课程, 曾为三星电子、招商信诺、风行网和拓维信息等企业提供咨询服务, 辅导客户实施敏捷组织转型, 并曾为顺丰航空、国航、中国移动、Oracle、东软集团、普华永道等数十家企业提供培训服务. 此外, 他还受邀担任中国过程改进大会、敏捷中国大会、Scrum Gathering等大会的评委和主持人, 并经常在全球软件案例研究峰会、亚太软件研发管理峰会、中国软件工程大会、中国软件技术大会、中国过程改进大会、CSDN CTO俱乐部、QClub、敏捷之旅等发表演讲. ', '', '', '上海市', '', '麦思博有限公司资深敏捷咨询顾问', '', ''),
(101, '王剑', '毕业后加盟微软雷德蒙总部。1999年1月-2000年5月在Windows CE组工作。2000年5月-2001年5月在NetDocs组工作。2001年5月-2003年6月 在Windows RTC 组工作。2001年7月加入微软亚洲研究院筹备微软亚洲工程院。2001年11月微软亚洲工程院成立他是20多创始人之一。工程院成立后他领导多个团队成功的发布多个产品，包括网络模拟器（Network Emulator），Office Communicator Web Access, Live Meeting Recording。', '', '', '北京市', '', '微软技术资深专家 微软亚洲院创始人之一', '', ''),
(102, '刘大双', '清华大学国际工程项目管理研究院特聘教授，国家职业技能鉴定专家委员会委员。\r\n微软项目管理顾问及Microsoft MVP，PMP（PMI，2003年）。\r\n北京大学理学士，美国Fordham 大学商学院工商管理硕士。\r\n1989年8月至1992年8月于北京大学任教。1992年8月加入IT行业，先后服务于美国SAS软件研究所、中国惠普有限公司等全球著名的IT企业。2001年10月至2004年9月担任微软（中国）有限公司Microsoft Project产品经理。', '', '', '北京市', '', 'Microsoft MVP, PMP', '', ''),
(103, '吴淏', '现任微软（中国）平台及开发合作部开发经理。目前专注于研究WCF,Office 2007 System,SaaS(Software as a Service)架构;负责微软SaaS架构技术在中国的应用推广，苏州SaaS孵化期，SaaS商务平台等。', '', '', '北京市', '', '微软开发合作部SaaS开发经理', '', ''),
(104, '王家林', 'TML5的软硬整合、HTML5和云计算的整合、HTML5游戏项目、HTML5的Web项目、 Android手机卫士、Android移植工作、Android上特定硬件的垂直整合、编写Java虚拟机、Android框架修改、Android娱乐多媒体软件（针对酷六、优酷、土豆等类型的网站）、大型B2C电子商务网站、大型SNS网站等.', '', '', '', '', '致力于HTML5和软、硬、云整合，智慧家庭，智能城市，精通Android安全', '', ''),
(1003, '朱少民', '中国科技大学软件学院教指委委员、中国软件测试认证委员会(CSTQB )资深专家、Certified ScrumMaster. 从事教育、研发和技术管理近二十年, 其中从事软件测试已有十多年, 参与多项重大科研项目的研究和几十个软件项目的产品开发, 获得多项省、市科技进步奖, 发表 多部著作, 其中有六本大学教材. 并且具有丰富的软件开发、测试的工程实践经验, 包括在海外工作和国际性一流软件企业的工作经历, 以及具有良好的教学和培训经验.', '', '华东地区', '上海市', '', '曾任思科—网迅 (中国)软件有限公司资深QA总监', '13909596672', 'kerryzhu');

-- --------------------------------------------------------

--
-- Table structure for table `co_teaching_fields`
--

CREATE TABLE IF NOT EXISTS `co_teaching_fields` (
  `teacher_id` bigint(20) NOT NULL,
  `course_type_id` int(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `co_teaching_fields`
--

INSERT INTO `co_teaching_fields` (`teacher_id`, `course_type_id`) VALUES
(104, 3),
(1003, 6),
(1003, 7),
(1003, 8),
...
INSERT INTO `co_users` (`uid`, `username`, `email`, `password`, `is_inspected`, `is_approved`, `is_email_validated`, `user_group_id`) VALUES
(100, 'user-100', 'user-100@zjhzxhz.com', '785ee107c11dfe36de668b1ae7baacbb', 1, 1, 0, 2),
(101, 'user-101', 'user-101@zjhzxhz.com', '785ee107c11dfe36de668b1ae7baacbb', 1, 1, 0, 2),
(102, 'user-102', 'user-102@zjhzxhz.com', '785ee107c11dfe36de668b1ae7baacbb', 1, 1, 0, 2),
(103, 'user-103', 'user-103@zjhzxhz.com', '785ee107c11dfe36de668b1ae7baacbb', 1, 0, 0, 2),
(104, 'user-104', 'user-104@zjhzxhz.com', '785ee107c11dfe36de668b1ae7baacbb', 0, 0, 0, 2),
(105, 'user-105', 'user-105@zjhzxhz.com', '785ee107c11dfe36de668b1ae7baacbb', 0, 0, 0, 2),
(106, 'user-106', 'user-106@zjhzxhz.com', '785ee107c11dfe36de668b1ae7baacbb', 0, 0, 0, 2),
(107, 'user-107', 'user-107@zjhzxhz.com', '785ee107c11dfe36de668b1ae7baacbb', 0, 0, 0, 2),
(108, 'user-108', 'user-108@zjhzxhz.com', '785ee107c11dfe36de668b1ae7baacbb', 0, 0, 0, 2),
(109, 'user-109', 'user-109@zjhzxhz.com', '785ee107c11dfe36de668b1ae7baacbb', 0, 0, 0, 2),
(110, 'user-110', 'user-110@zjhzxhz.com', '785ee107c11dfe36de668b1ae7baacbb', 0, 0, 0, 2),
(111, 'user-111', 'user-111@zjhzxhz.com', '785ee107c11dfe36de668b1ae7baacbb', 0, 0, 0, 2),
(112, 'user-112', 'user-112@zjhzxhz.com', '785ee107c11dfe36de668b1ae7baacbb', 0, 0, 0, 2),
(113, 'user-113', 'user-113@zjhzxhz.com', '785ee107c11dfe36de668b1ae7baacbb', 0, 0, 0, 2),
(114, 'user-114', 'user-114@zjhzxhz.com', '785ee107c11dfe36de668b1ae7baacbb', 0, 0, 0, 2),
(115, 'user-115', 'user-115@zjhzxhz.com', '785ee107c11dfe36de668b1ae7baacbb', 0, 0, 0, 2),
(116, 'user-116', 'user-116@zjhzxhz.com', '785ee107c11dfe36de668b1ae7baacbb', 0, 0, 0, 2),
(117, 'user-117', 'user-117@zjhzxhz.com', '785ee107c11dfe36de668b1ae7baacbb', 0, 0, 0, 2),
...
--
-- Table structure for table `co_user_groups`
--

CREATE TABLE IF NOT EXISTS `co_user_groups` (
`user_group_id` int(4) NOT NULL,
...
--
-- Dumping data for table `co_user_groups`
--

INSERT INTO `co_user_groups` (`user_group_id`, `user_group_slug`, `user_group_name`) VALUES
(1, 'person', '个人'),
(2, 'teacher', '讲师'),
(3, 'company', '企业'),
(4, 'administrator', '管理员');
...
--
-- Indexes for table `co_email_validation`
--
ALTER TABLE `co_email_validation`
 ADD PRIMARY KEY (`email`);

--
-- Indexes for table `co_lectures`
--
ALTER TABLE `co_lectures`
 ADD PRIMARY KEY (`lecture_id`), ADD KEY `course_id` (`course_id`);

--
-- Indexes for table `co_lecture_attendance`
--
ALTER TABLE `co_lecture_attendance`
 ADD PRIMARY KEY (`uid`,`lecture_id`), ADD KEY `lecture_id` (`lecture_id`);

--
-- Indexes for table `co_lecture_schedule`
--
ALTER TABLE `co_lecture_schedule`
 ADD PRIMARY KEY (`lecture_id`,`course_module_id`), ADD KEY `course_module_id` (`course_module_id`);

--
-- Indexes for table `co_messages`
--
ALTER TABLE `co_messages`
...
--
-- Indexes for table `co_options`
--
ALTER TABLE `co_options`
 ADD PRIMARY KEY (`option_id`), ADD UNIQUE KEY `option_key` (`option_key`);

--
-- Indexes for table `co_people`
--
ALTER TABLE `co_people`
...
--
-- Indexes for table `co_posts`
--
ALTER TABLE `co_posts`
 ADD PRIMARY KEY (`post_id`), ADD KEY `news_category_id` (`post_category_id`), ADD KEY `news_category_id_2` (`post_category_id`);

--
-- Indexes for table `co_post_categories`
--
ALTER TABLE `co_post_categories`
 ADD PRIMARY KEY (`post_category_id`);

--
-- Indexes for table `co_requirements`
--
ALTER TABLE `co_requirements`
...
--
-- Indexes for table `co_teaching_fields`
--
ALTER TABLE `co_teaching_fields`
...
--
-- Indexes for table `co_user_groups`
--
ALTER TABLE `co_user_groups`
...
MODIFY `uid` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1005;
--
-- AUTO_INCREMENT for table `co_user_groups`
--
ALTER TABLE `co_user_groups`
...
--
-- Constraints for table `co_comments`
--
ALTER TABLE `co_comments`
ADD CONSTRAINT `co_comments_ibfk_1` FOREIGN KEY (`lecture_id`) REFERENCES `co_lectures` (`lecture_id`),
ADD CONSTRAINT `co_comments_ibfk_2` FOREIGN KEY (`reviewer_uid`) REFERENCES `co_users` (`uid`);

--
-- Constraints for table `co_companies`
--
ALTER TABLE `co_companies`
ADD CONSTRAINT `co_companies_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `co_users` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `co_companies_ibfk_2` FOREIGN KEY (`company_field_id`) REFERENCES `co_company_fields` (`company_field_id`);

--
-- Constraints for table `co_courses`
--
ALTER TABLE `co_courses`
ADD CONSTRAINT `co_courses_ibfk_1` FOREIGN KEY (`course_type_id`) REFERENCES `co_course_types` (`course_type_id`),
ADD CONSTRAINT `co_courses_ibfk_2` FOREIGN KEY (`teacher_id`) REFERENCES `co_teachers` (`uid`);

--
-- Constraints for table `co_course_composition`
--
ALTER TABLE `co_course_composition`
ADD CONSTRAINT `co_course_composition_ibfk_1` FOREIGN KEY (`course_id`) REFERENCES `co_courses` (`course_id`),
ADD CONSTRAINT `co_course_composition_ibfk_2` FOREIGN KEY (`course_module_id`) REFERENCES `co_course_modules` (`course_module_id`);

--
-- Constraints for table `co_course_modules`
--
ALTER TABLE `co_course_modules`
ADD CONSTRAINT `co_course_modules_ibfk_1` FOREIGN KEY (`teacher_id`) REFERENCES `co_teachers` (`uid`);

--
-- Constraints for table `co_email_validation`
--
ALTER TABLE `co_email_validation`
ADD CONSTRAINT `co_email_validation_ibfk_1` FOREIGN KEY (`email`) REFERENCES `co_users` (`email`);

--
-- Constraints for table `co_lectures`
--
ALTER TABLE `co_lectures`
ADD CONSTRAINT `co_lectures_ibfk_1` FOREIGN KEY (`course_id`) REFERENCES `co_courses` (`course_id`);

--
-- Constraints for table `co_lecture_attendance`
--
ALTER TABLE `co_lecture_attendance`
ADD CONSTRAINT `co_lecture_attendance_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `co_users` (`uid`),
ADD CONSTRAINT `co_lecture_attendance_ibfk_2` FOREIGN KEY (`lecture_id`) REFERENCES `co_lectures` (`lecture_id`);

--
-- Constraints for table `co_lecture_schedule`
--
ALTER TABLE `co_lecture_schedule`
ADD CONSTRAINT `co_lecture_schedule_ibfk_1` FOREIGN KEY (`lecture_id`) REFERENCES `co_lectures` (`lecture_id`),
ADD CONSTRAINT `co_lecture_schedule_ibfk_2` FOREIGN KEY (`course_module_id`) REFERENCES `co_course_modules` (`course_module_id`);

--
-- Constraints for table `co_messages`
--
ALTER TABLE `co_messages`
ADD CONSTRAINT `co_messages_ibfk_1` FOREIGN KEY (`message_from_uid`) REFERENCES `co_users` (`uid`),
ADD CONSTRAINT `co_messages_ibfk_2` FOREIGN KEY (`message_to_uid`) REFERENCES `co_users` (`uid`);

--
-- Constraints for table `co_people`
--
ALTER TABLE `co_people`
ADD CONSTRAINT `co_people_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `co_users` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `co_people_ibfk_2` FOREIGN KEY (`person_position_id`) REFERENCES `co_positions` (`position_id`);

--
-- Constraints for table `co_posts`
--
ALTER TABLE `co_posts`
ADD CONSTRAINT `co_posts_ibfk_1` FOREIGN KEY (`post_category_id`) REFERENCES `co_post_categories` (`post_category_id`);

--
-- Constraints for table `co_requirements`
--
ALTER TABLE `co_requirements`
ADD CONSTRAINT `co_requirements_ibfk_1` FOREIGN KEY (`requirement_from_uid`) REFERENCES `co_users` (`uid`),
ADD CONSTRAINT `co_requirements_ibfk_2` FOREIGN KEY (`requirement_to_uid`) REFERENCES `co_users` (`uid`),
ADD CONSTRAINT `co_requirements_ibfk_3` FOREIGN KEY (`requirement_course_id`) REFERENCES `co_courses` (`course_id`);

--
-- Constraints for table `co_teachers`
--
ALTER TABLE `co_teachers`
ADD CONSTRAINT `co_teachers_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `co_users` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `co_teaching_fields`
--
ALTER TABLE `co_teaching_fields`
ADD CONSTRAINT `co_teaching_fields_ibfk_1` FOREIGN KEY (`teacher_id`) REFERENCES `co_teachers` (`uid`),
ADD CONSTRAINT `co_teaching_fields_ibfk_2` FOREIGN KEY (`course_type_id`) REFERENCES `co_course_types` (`course_type_id`);

--
-- Constraints for table `co_users`
--
ALTER TABLE `co_users`
ADD CONSTRAINT `co_users_ibfk_1` FOREIGN KEY (`user_group_id`) REFERENCES `co_user_groups` (`user_group_id`);
