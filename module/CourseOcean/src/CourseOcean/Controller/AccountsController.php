...
class AccountsController extends AbstractActionController
{
    ...
    {
        $serviceManager         = $this->getServiceLocator();
        $emailValidationTable   = $serviceManager->get('CourseOcean\Model\EmailValidationTable');
    ...
    private function sendResetPasswordEmail($username, $email) {
        ...
        $serviceManager = $this->getServiceLocator();
        $transport      = $serviceManager->get('CourseOcean\Mail\Transport');
    ...
    public function getPageContentAction()
    {
        ...
        $template = "/course-ocean/accounts/dashboard/$pageName.phtml";
    ...
    {
        $serviceManager = $this->getServiceLocator();
        $personTable    = $serviceManager->get('CourseOcean\Model\PersonTable');
    ...
    {
        $serviceManager = $this->getServiceLocator();
        $positionTable  = $serviceManager->get('CourseOcean\Model\PositionTable');
    ...
    public function getTeachingFieldsAction()
    {
        ...
        $uid                = $profile['uid'];
        $serviceManager     = $this->getServiceLocator();
        $teachingFieldTable = $serviceManager->get('CourseOcean\Model\TeachingFieldTable');
    ...
    {
        $serviceManager = $this->getServiceLocator();
        $companyTable   = $serviceManager->get('CourseOcean\Model\CompanyTable');
    ...
    {
        $serviceManager     = $this->getServiceLocator();
        $companyFieldTable  = $serviceManager->get('CourseOcean\Model\CompanyFieldTable');
    ...
    public function getLectureAttendanceAction()
    {
        ...
        $serviceManager     = $this->getServiceLocator();
        $attendanceTable    = $serviceManager->get('CourseOcean\Model\LectureAttendanceTable');
    ...
    public function createLectureScheduleAction()
    {
        ...
        $serviceManager         = $this->getServiceLocator();
        $lectureScheduleTable   = $serviceManager->get('CourseOcean\Model\LectureScheduleTable');
        $result   = array(
    ...
    public function createCourseAction()
    {
        ...
        if ( $result['isSuccessful'] ) {
            ...
            $courseCompositionTable = $serviceManager->get('CourseOcean\Model\CourseCompositionTable');
    ...
    public function getRequirementsAction()
    {
        ...
        $serviceManager                     = $this->getServiceLocator();
        $requirementTable                   = $serviceManager->get('CourseOcean\Model\RequirementTable');
