...
class LectureController extends AbstractActionController
{
    ...
    private function getAllLectures($pageNumber, $limit)
    {
        ...
        $lectureTable   = $sm->get('Solution\Model\LectureTable');
    ...
    {
        $sm                 = $this->getServiceLocator();
        $courseTypeTable    = $sm->get('Solution\Model\CourseTypeTable');
    ...
    {
        $sm                 = $this->getServiceLocator();
        $lectureMetaTable   = $sm->get('Solution\Model\LectureMetaTable');
    ...
    {
        $sm                 = $this->getServiceLocator();
        $courseMetaTable    = $sm->get('Solution\Model\CourseMetaTable');
    ...
    {
        $sm                 = $this->getServiceLocator();
        $attendanceTable    = $sm->get('Solution\Model\LectureAttendanceTable');
